...
$test_messages = [ 
	["id" => 1, "text" => "How many days did you meet that goal?", 						"scope" => "WEEK", "source" => "STEPS", "subject" => "goal", "goal_scope" => ["daily"], "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/019f89a7-f3bd-4d4f-8bd3-2d6cc464714b?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q="],
	...
	["id" => 5, "text" => "Can you spot any weekly patterns in your data?", 			"scope" => "2WEEKS", "source" => "STEPS", "subject" => "pattern", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/8501ae69-54dd-4cd8-909b-ef46bd5d9758?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q="],
	["id" => 6, "text" => "Do you remember to wear your fitbit every day?", 			"scope" => "WEEK", "source" => "STEPS", "subject" => "activity", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/f6524bd8-0c1e-4269-9097-03c683ecec2f?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q="],
	...
	["id" => 16, "text" => "Do your friends exercise more than you do?", 					"scope" => "NONE", "source" => "NONE", "subject" => "social", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/2767ae60-5e0f-44f3-9295-372a8e684eb6?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q=" ],
	["id" => 17, "text" => "Do you think you can be more active?", 							"scope" => "WEEK", "source" => "STEPS", "subject" => "achievement", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/63397085-3639-4db6-a9ce-c8921596713a?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q=" ],
	["id" => 18, "text" => "What kinds of activities would help you burn more calories?", 	"scope" => "NONE", "source" => "NONE", "subject" => "activity"],
	["id" => 19, "text" => "Is there anything happening next week that could reduce your level of physical activity?", 	"scope" => "NONE", "source" => "NONE", "subject" => "activity",  "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/4cb588e9-f7e2-47ea-9fbf-1c10e0f9cd3f?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&q="],
	["id" => 20, "text" => "Is there anything else that you would like to track besides what Fitbit already tracks?", 	"scope" => "NONE", "source" => "NONE", "subject" => "activity",  "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/abb42dd7-d7ac-4962-a0ba-ef4a1ede8bc7?subscription-key=215eb891caf544c298d700f040478fb6&verbose=true&timezoneOffset=0&spellCheck=true&q="]
];
