...
$test_messages = [ 
	["id" => 1, "text" => "How many days did you meet that goal?", 						"scope" => "WEEK", "source" => "STEPS", "subject" => "goal", "goal_scope" => ["daily"], "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/3ca81f13-52ab-41f4-98a8-d7090b474baa?subscription-key=215eb891caf544c298d700f040478fb6&timezoneOffset=0&verbose=true&q="],
	...
	["id" => 5, "text" => "Can you spot any weekly patterns in your data?", 			"scope" => "2WEEKS", "source" => "STEPS", "subject" => "pattern", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/3ca81f13-52ab-41f4-98a8-d7090b474baa?subscription-key=215eb891caf544c298d700f040478fb6&timezoneOffset=0&verbose=true&q="],
	["id" => 6, "text" => "Do you remember to wear your fitbit everyday?", 				"scope" => "WEEK", "source" => "STEPS", "subject" => "activity", "luis_url" => "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/3ca81f13-52ab-41f4-98a8-d7090b474baa?subscription-key=215eb891caf544c298d700f040478fb6&timezoneOffset=0&verbose=true&q="],
