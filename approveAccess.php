...
//$FITBIT_ID = "2289FH";
//$CONSUMER_SECRET = "ef4ebf7de72b808809130294e8c17ace";

$code = isset($_GET['code']) ? $_GET['code'] : NULL;
$user_id = isset($_GET['user_id']) ? $_GET['user_id'] : NULL;
#$fitbit_profile_id = NULL;
$fitbit_id = "2289FH";
$fitbit_secret = "ef4ebf7de72b808809130294e8c17ace";
...
/*if ($user_id) {
	...
	$fitbit_id = "2289FH"; #getFitbitID($fitbit_profile_id);
	$fitbit_secret = "ef4ebf7de72b808809130294e8c17ace"; #getFitbitSecret($fitbit_profile_id);
